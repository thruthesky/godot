...
| **6** | **[에디터 화면](basics/06-editor-screen.md)** | **어떤 파일을 어디서 고치나**·4개 독의 역할·저장 단축키·`res://`·**▶ 실행 창 크기를 정하는 세 곳**·FileSystem 에서 파일 숨기기 | 465 |
...
`references/basics/06-editor-screen.md` · **465줄** · 소제목 5개
